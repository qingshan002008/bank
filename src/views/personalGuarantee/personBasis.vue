<template>
          ...
          <table >
            ...
            <tr >
              <td colspan="3" style="text-align:center;">
                <el-form-item>
					        <el-button type="primary" v-on:click="getPersonBasics">查询</el-button>
              </el-form-item>
              <el-form-item>
  ...
  <el-table :data="personBasics" highlight-current-row v-loading="listLoading"  style="width: 100%;"  stripe='true'>
      <!-- <el-table-column type="selection" width="55">
			</el-table-column> -->
      <el-table-column prop="type" label="信息记录类型" width="120">
			</el-table-column>
			<el-table-column prop="contractNo" label="账户标示码" width="120" sortable>
			</el-table-column>
...
<script>
import {getPersonBasicList} from '../../api/personalGuarantee.js'
export default {
    data() {
			return {
        filters:{
    ...
    methods:{
      getPersonBasics(){
        ...
        // },1000)
        getPersonBasicList(para).then((res) => {
					this.total = res.data.total;
					this.personBasics = res.data.personBasics;
					this.listLoading = false;
					//NProgress.done();
				});
