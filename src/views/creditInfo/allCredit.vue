<template>
  ...
  <section>
        ...
        <el-form ref="contractForm" :model="filters" :inline="true"   >
          <table >
            <tr>
              <td>
                <el-form-item label="共同授信人名称"  prop='name'>
					        <el-input v-model="filters.name" placeholder="共同授信人名称"></el-input>
				        </el-form-item>
              </td>
                <td>
                <el-form-item label="共同授信人身份类型" prop='cardType'>
                    <el-select v-model="filters.cardType" placeholder="共同授信人身份类型">
                    <el-option
              ...
              <td>
                <el-form-item label="共同授信人身份标示号码" prop='cardNo'>
                    <el-input v-model="filters.cardNo" placeholder="共同授信人身份标示号码"></el-input>
                  </el-form-item>
              </td>
            </tr>
            <tr >
  ...
  <el-table :data="contractMarks" highlight-current-row v-loading="listLoading"  style="width: 100%;"  stripe='true'>
      ...
      <el-table-column prop="collateralCount" label="共同授信人个数" width="120"  sortable>
			</el-table-column>
      <el-table-column prop="infoType" label="身份类型" width="120" sortable>
			</el-table-column>
      <el-table-column prop="name" label="共同授信人名称" min-width="100" sortable>
			</el-table-column>
