<template>
          ...
          <table >
            <tr>
              <td >
                ...
                <td >
                <el-form-item label="额度到期日期" prop='endDate'>
                   <el-date-picker
  ...
  <el-table :data="basicInfos" highlight-current-row v-loading="listLoading"  style="width: 100%;"  stripe='true'>
      <!-- <el-table-column type="selection" width="55">
            ...
            <el-table-column prop="creditType" label="授信额度类型" width="110">
			</el-table-column>
            <el-table-column prop="loopFlag" label="额度循标志" width="100">
			</el-table-column>
			<el-table-column prop="money" label="授信额度" width="120" sortable>
			</el-table-column>
			<el-table-column prop="moneyType" label="币种" width="180"  sortable>
			</el-table-column>
			<el-table-column prop="startDate" label="额度生效日期" width="180" sortable>
			</el-table-column>
			<el-table-column prop="endDate" label="额度到期日期" width="180" sortable>
			</el-table-column>
            <el-table-column prop="state" label="额度状态" min-width="100" sortable>
			</el-table-column>
			<el-table-column prop="moneyQuota" label="授信限额" width="180" sortable>
			</el-table-column>
            <el-table-column prop="bianma" label="授信限额编码" min-width="100" sortable>
			</el-table-column>
  </el-table>
  <!--工具条-->
